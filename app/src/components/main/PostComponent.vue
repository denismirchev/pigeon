<template>
  <div :class="['bg-white border border-gray-200 rounded-lg p-4 mt-4', { 'hover-effect': isLink }]" @click="isClicked">    <!-- Original Post Content -->
    <div class="flex items-center space-x-4">
      <img :src="`http://localhost:3000/uploads/pfps/${post.user.profileImageUrl}` || 'https://via.placeholder.com/150'" alt="Profile" class="w-10 h-10 rounded-full" />
      <div>
...
<!--        <span :class="{ 'text-red-500': liked, 'animate-like': likedAnimation }" @click.stop="toggleLike" class="cursor-pointer flex items-center">-->
        <span :class="{ 'text-red-500': liked }" @click.stop="toggleLike" class="cursor-pointer flex items-center">
